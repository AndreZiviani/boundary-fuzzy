module github.com/AndreZiviani/boundary-fuzzy
...
require (
	...
	github.com/hashicorp/boundary v0.18.1
	...
	github.com/hashicorp/go-kms-wrapping/v2 v2.0.17-0.20240313190905-91d44aa8e360 // indirect
